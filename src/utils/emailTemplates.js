...
const RESET_PASSWORD_SUCCESSFUL_TEMPLATE = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Password Reset Successful - FitAddis</title>
    <style type="text/css">
        /* Email Client Resets */
        body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
        table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }
        ...
        <tr>
            <td align="center" style="padding: 40px 0;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="email-container" style="max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td align="center" style="padding-bottom: 30px;">
                            <!-- Logo: Exact same styling (No dot, weight 600, letter-spacing 0.5px) -->
                            <span style="color:#00e599; font-size:22px; font-weight:600; letter-spacing:0.5px; font-family:'Segoe UI', 'Helvetica Neue', sans-serif;">FitAddis</span>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="email-container" style="max-width: 600px; background-color: #1a2634; border-radius: 8px; overflow: hidden;">
                    <tr>
                        <td align="center" style="padding: 40px 30px;">
                            ...
                            <p style="color: #8b9bb5; font-size: 16px; line-height: 1.6; margin: 0 0 25px 0; text-align: left;">
                                Your FitAddis account password has been successfully updated. 
                                You can now securely log in with your new credentials and get back to your fitness journey.
                            </p>

                            <!-- CTA Button (Exactly styled like the previous 'Reset Password' button) -->
                            <table border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                                <tr>
                                    <td align="center" style="background-color: #00e599; border-radius: 6px;">
                                        <a href="{LOGIN_LINK}" style="display: block; padding: 16px 40px; color: #0b141e; font-family: 'Segoe UI', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; text-decoration: none; text-align: center;">
                            ...
                            <!-- Secondary Box (Maintains the exact design spacing from the previous fallback box) -->
                            <div style="background-color: #0b141e; border: 1px solid #2c3e50; padding: 15px; border-radius: 6px; text-align: center; margin-top: 25px;">
                                <p style="color: #8b9bb5; font-size: 13px; margin: 0 0 5px 0;">If you did not make this change, please contact our support team immediately.</p>
                                <a href="mailto:support@fitaddis.com" style="color: #00e599; font-size: 14px; font-weight: bold; text-decoration: underline;">support@fitaddis.com</a>
                            </div>

                            <!-- Security Note Footer -->
                            <p style="color: #8b9bb5; font-size: 13px; line-height: 1.4; margin: 25px 0 0 0; text-align: left; border-top: 1px solid #2c3e50; padding-top: 20px;">
                                This is an automated message from FitAddis. For your protection, please do not share your password with anyone.
                            </p>
